...
int main(){
    ...
    int roll2, contar = 0,i=0, op, temp, lim=0, j=0, resp;
    ...
    if (lee.is_open()){
        ...
        while(salida==false){
            ...
            cout<<"1) Ordenar por duracion mayor a menor\n";
            cout<<"2) Buscar una cancion\n";
            cout<<"3) Buscar por rango de duracion\n";
            cout<<"4) Agregar Cancion\n";
            cout<<"5) Ordenar por duracion menor a mayor\n";
            cout<<"6) Salir\n";
            cin>>op;
            cout<<endl;
            ...
            case 5:
                {
                    // Visualizar Splay tree
                    cout<<splay.inorder()<<endl;
                    cout<<"Desea visualizar el arbol?"<<endl;
                    cout<<"1- Si\n2- No\n";
                    cin>>resp;
                    if(resp==1){
                        cout<<"Pre order\n";
                        cout<<splay.preorder()<<endl;
                        cout<<"Print tree\n";
